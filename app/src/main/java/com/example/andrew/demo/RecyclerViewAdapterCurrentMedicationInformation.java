...
public class RecyclerViewAdapterCurrentMedicationInformation
        extends RecyclerView.Adapter<RecyclerViewAdapterCurrentMedicationInformation.ViewHolder> {

    private ArrayList<String> listOfData;
    private String highlightedText = "";
    private static final String TAG = RecyclerViewAdapterCurrentMedicationInformation.class.getSimpleName();
    ...
    private static final int gray = Color.parseColor("#4D4D4D");
    ...
    RecyclerViewAdapterCurrentMedicationInformation(ArrayList<String> listOfData) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View view = inflater.inflate(R.layout.row_no_therapeutic, parent, false);
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
            ...
            if (s.equals("\t")) {
                switch (element) {
                    ...
                    case 3: //case 3 and 4 are both under "Drug Impacted" (case 3 is title, and case 4 is text)
                        ...
                        break;
                    case 4:
                        //In this case, column 10 contains drug names
                        break;
                    case 5:
        ...
        //TODO: Get missing N/A images and add them with name PGNA
        //setting images
        ...
        } else if (ivActionString.equals("PGNA")) {
            holder.ivAction2.setVisibility(View.GONE);
            holder.ivAction1.setLayoutParams(paramsFull);
            holder.ivAction1.setLayoutParams(paramsEmpty);
            holder.ivAction1.setImageResource(R.mipmap.not_available_icon_final);
            holder.ivAction1.setBackgroundColor(gray);
        } else if (ivActionString.equals("WE")) { //TODO: What is the string abbreviation for the weak evidence image?
            holder.ivAction2.setVisibility(View.GONE);
            holder.ivAction1.setLayoutParams(paramsFull);
            holder.ivAction1.setLayoutParams(paramsEmpty);
            holder.ivAction1.setImageResource(R.mipmap.weak_evidence_icon_final);
            holder.ivAction1.setBackgroundColor(gray);
        } else {
        ...
        final String INCREASE_DOSE = "INCREASE DOSE";
        final String NORMAL_DOSE = "NORMAL DOSE";
        final String CLINICAL_INTERPRETATION_NOT_AVAILABLE = "CLINICAL INTERPRETATION NOT AVAILABLE";
        final String PHARMACOGENOMICS_EVIDENCE_NOT_AVAILABLE = "PHARMACOGENOMICS EVIDENCE NOT AVAILABLE";
        ...
        tvClinicalInterpretationString = tvClinicalInterpretationString.replace((CONSIDER_ALTERNATIVES + " "), (CONSIDER_ALTERNATIVES + "\r\n"))
                ...
                .replace((CLINICAL_INTERPRETATION_NOT_AVAILABLE + " "), (CLINICAL_INTERPRETATION_NOT_AVAILABLE + "\r\n"))
                .replace((PHARMACOGENOMICS_EVIDENCE_NOT_AVAILABLE + " "), (PHARMACOGENOMICS_EVIDENCE_NOT_AVAILABLE + "\r\n"));
        ...
        if (tvClinicalInterpretationString.contains(CLINICAL_INTERPRETATION_NOT_AVAILABLE)) { // gray

            spannableClinicalInterpretation.setSpan(new ForegroundColorSpan(gray), tvClinicalInterpretationString.indexOf(CLINICAL_INTERPRETATION_NOT_AVAILABLE), (tvClinicalInterpretationString.indexOf(CLINICAL_INTERPRETATION_NOT_AVAILABLE) + CLINICAL_INTERPRETATION_NOT_AVAILABLE.length()), Spannable.SPAN_INCLUSIVE_INCLUSIVE);
            spannableClinicalInterpretation.setSpan(new StyleSpan(Typeface.BOLD), tvClinicalInterpretationString.indexOf(CLINICAL_INTERPRETATION_NOT_AVAILABLE), (tvClinicalInterpretationString.indexOf(CLINICAL_INTERPRETATION_NOT_AVAILABLE) + CLINICAL_INTERPRETATION_NOT_AVAILABLE.length()), Spannable.SPAN_INCLUSIVE_INCLUSIVE);

            holder.tvClinicalInterpretation.setText(spannableClinicalInterpretation, TextView.BufferType.SPANNABLE);
        }
        if (tvClinicalInterpretationString.contains(PHARMACOGENOMICS_EVIDENCE_NOT_AVAILABLE)) { // gray

            spannableClinicalInterpretation.setSpan(new ForegroundColorSpan(gray), tvClinicalInterpretationString.indexOf(PHARMACOGENOMICS_EVIDENCE_NOT_AVAILABLE), (tvClinicalInterpretationString.indexOf(PHARMACOGENOMICS_EVIDENCE_NOT_AVAILABLE) + PHARMACOGENOMICS_EVIDENCE_NOT_AVAILABLE.length()), Spannable.SPAN_INCLUSIVE_INCLUSIVE);
            spannableClinicalInterpretation.setSpan(new StyleSpan(Typeface.BOLD), tvClinicalInterpretationString.indexOf(PHARMACOGENOMICS_EVIDENCE_NOT_AVAILABLE), (tvClinicalInterpretationString.indexOf(PHARMACOGENOMICS_EVIDENCE_NOT_AVAILABLE) + PHARMACOGENOMICS_EVIDENCE_NOT_AVAILABLE.length()), Spannable.SPAN_INCLUSIVE_INCLUSIVE);

...
public class RecyclerViewAdapterPatientSpecificDrugInformation
        extends RecyclerView.Adapter<RecyclerViewAdapterPatientSpecificDrugInformation.ViewHolder> {

    private ArrayList<String> listOfData;
    private String highlightedText = "";
    private static final String TAG = RecyclerViewAdapterPatientSpecificDrugInformation.class.getSimpleName();
    ...
    RecyclerViewAdapterPatientSpecificDrugInformation(ArrayList<String> listOfData) {

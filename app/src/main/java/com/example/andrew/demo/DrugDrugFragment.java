...
public class DrugDrugFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View rootView = inflater.inflate(R.layout.fragment_current_drug_interactions_drug_drug, container, false);
        ...
        tvSummary.setText("Drug-Drug Interactions for");

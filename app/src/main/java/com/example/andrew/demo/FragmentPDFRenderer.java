 ...
 */
public class  FragmentPDFRenderer extends Fragment implements View.OnClickListener {
     ...
     */
    private static final String FILENAME = "output_report.pdf";

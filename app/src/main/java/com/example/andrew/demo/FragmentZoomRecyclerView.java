...
public class FragmentZoomRecyclerView extends RecyclerView {
    private FragmentRecyclerViewHeaderDecorator recyclerViewHeaderDecorator;
    ...
    public void setRecyclerViewHeaderDecorator(FragmentRecyclerViewHeaderDecorator recyclerViewHeaderDecorator) {
        this.recyclerViewHeaderDecorator = recyclerViewHeaderDecorator;
    }

    public FragmentZoomRecyclerView(Context context, AttributeSet attrs) {
        super(context, attrs);

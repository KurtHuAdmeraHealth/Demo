...
public class FragmentRecyclerViewHeaderDecorator extends FragmentZoomRecyclerView.ItemDecoration{
    private static final String TAG = FragmentRecyclerViewHeaderDecorator.class.getSimpleName();
    private View header;
    ...
    public FragmentRecyclerViewHeaderDecorator(View header) {
        this.header = header;
    }

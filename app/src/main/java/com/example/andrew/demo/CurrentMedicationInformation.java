...
public class CurrentMedicationInformation extends AppCompatActivity {

    public static final String TAG = CurrentMedicationInformation.class.getName();
    ZoomRecyclerView zlvChart;
    ArrayList<String> listOfData = new ArrayList<>();
    RecyclerViewAdapterCurrentMedicationInformation recyclerViewAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_current_medication_information);
        ...
        try {
            ...
            while ((line = br.readLine()) != null) {
                if (!line.startsWith("\t") //does not include drug interactions and certain other data
                        && !line.startsWith("DDI")
                        && !line.startsWith("DFI")
                        && !line.startsWith("DAI")
                        && !line.startsWith("DLI")) {
        ...
        tvSummary.setText("Current Medication Information for");
        ...
        recyclerViewAdapter = new RecyclerViewAdapterCurrentMedicationInformation(listOfData);
        if (zlvChart != null) {
            zlvChart.setAdapter(recyclerViewAdapter);
        }
        if (getResources().getConfiguration().orientation == Configuration.ORIENTATION_PORTRAIT) {
            zlvChart.setMaxHeight(501);
        } else {
            zlvChart.setMaxHeight(242);
        }
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        simpleCursorAdapter = new MySimpleCursorAdapter(
                CurrentMedicationInformation.this,
        ...
        searchView.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
            ...
            public boolean onQueryTextSubmit(String newText) { //when the user presses the enter button
                ...
                if (!newText.isEmpty()) {
                    ...
                    recyclerViewAdapter = new RecyclerViewAdapterCurrentMedicationInformation(newList);
                    zlvChart.setAdapter(recyclerViewAdapter);
